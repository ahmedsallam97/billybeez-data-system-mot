...
const DEFAULT_OPS_SCHEDULE_CODE_CONFIG = {
  AM: { label: "AM", color: "#f4d96b" }, BW: { label: "BW", color: "#72b7e5" }, PM: { label: "PM", color: "#477bb8" },
  Annual: { label: "Annual", color: "#77bd88" }, Rep: { label: "Rep", color: "#e9c74f" }, OFF: { label: "OFF", color: "#eaa3ba" }, SL: { label: "SL", color: "#edc3cb" },
  Unpaid: { label: "Unpaid", color: "#e9a35f" }, Mission: { label: "Mission", color: "#82c9dc" }, Holiday: { label: "Holiday", color: "#8c3651" },
  ANP: { label: "ANP", color: "#ef8d8d" }, AWP: { label: "AWP", color: "#b7424d" }
};
const DEFAULT_OPS_ROTATION_RULES = { slotsPerShift: 8, preserveManualLocks: true, excludeCashiers: true, prioritizeMandatoryPositions: true, mandatoryPositionCodes: ["DATA"], avoidConsecutivePosition: true };
