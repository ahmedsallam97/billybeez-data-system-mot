...
export default function PerformanceWorkspace() {
  ...
  const templateWinner = competition?.winner ? { ...competition, employee: competition.winner, branch: "MOT" } : null;
