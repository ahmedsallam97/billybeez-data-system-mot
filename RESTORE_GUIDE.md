...
The package contains 12 protected employee files in 12 employee folders. Copy the whole tree; do not rename folders or files because database metadata points to their storage keys.
...
At package creation, employee storage contained 12 protected files across 12 employee folders. Confirm authenticated document/photo routes can open representative files after restoration.
